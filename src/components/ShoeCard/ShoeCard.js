...
const Wrapper = styled.article`
    ...
    &:has(${NewFlag}) ${Image}:hover {
        filter: drop-shadow(16px 16px 33px var(--color-secondary));
    }
    &:has(${SaleFlag}) ${Image}:hover {
        filter: drop-shadow(16px 16px 33px var(--color-primary));
    }
`;
